...
p. While these IDs are really handy, they're hard to memorize and type. So here's the good news: You can use tab completion for this! To specify this issue on the command line, you can type any of the following:
